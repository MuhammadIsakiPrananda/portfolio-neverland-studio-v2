          ...
          >
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 mb-8 backdrop-blur-sm">
                ...
                <span className="text-xs font-bold text-blue-400 tracking-wider uppercase">LIVE INTELLIGENCE FEED</span>
              </div>

              {/* Title */}
              <div className="flex items-center justify-center mb-6">
                <Globe className="w-10 h-10 md:w-12 md:h-12 text-blue-500 mr-4" />
                <h1 className="text-4xl md:text-5xl font-bold text-white">
                  Global Cyber <span className="text-blue-500">News</span>
                </h1>
              </div>
            ...
            >
              {/* Total Articles */}
              <motion.div variants={staggerItem} className="bg-white/5 backdrop-blur-sm rounded-lg px-6 py-3 border border-white/10 min-w-[140px]">
                <div className="text-sm text-gray-400 mb-1">Live Articles</div>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between mb-8 z-20 relative">
            ...
            <div className="flex items-center gap-2 w-full md:w-auto">
              <div className="relative flex-1 md:w-72">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-white/[0.03] border border-white/10 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-purple-500/50 transition-all"
                />
              </div>
            ...
            <div className="relative w-full md:w-64" ref={dropdownRef}>
              <button
                ...
                className="w-full flex items-center justify-between pl-4 pr-4 py-2.5 rounded-lg bg-white/[0.03] border border-white/10 text-sm text-white focus:outline-none focus:border-purple-500/50 hover:bg-white/[0.08] transition-all"
              >
              ...
              <AnimatePresence>
                {isDropdownOpen && (
                  <motion.div
                    ...
                    className="absolute top-full text-left left-0 right-0 mt-2 bg-[#0a0a0a] border border-white/10 rounded-xl shadow-xl shadow-purple-500/10 overflow-hidden z-50 backdrop-blur-xl"
                  >
                    <div className="py-1 max-h-60 overflow-y-auto">
                      {categories.map((cat) => (
                        <button
                          ...
                          className="w-full px-4 py-2.5 text-sm text-left text-gray-300 hover:text-white hover:bg-white/[0.05] transition-colors flex items-center justify-between group"
                        >
                          <span>{cat.label}</span>
                ...
                `}>
                    ...
                    {item.imageUrl && (
                      <div className="relative h-40 overflow-hidden">
                        ...
                        {/* Absolute Time Badge */}
                        <div className="absolute bottom-3 right-3 px-2 py-1 rounded-md bg-black/60 backdrop-blur-sm border border-white/10 text-xs font-medium text-white flex items-center gap-1.5">
                    ...
                    <div className="p-6 flex-1 flex flex-col">
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                          <span className={`px-2.5 py-1 rounded-full text-[10px] uppercase font-bold tracking-wider border ${getCategoryColor(item.category)}`}>
                            {item.category}
                          </span>
                        </div>
                        {item.severity === 'high' && (
                          <span className="flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-bold bg-red-500/10 border border-red-500/20 text-red-500 animate-pulse">
                      ...
                      {/* Footer */}
                      <div className="mt-auto flex items-center justify-between text-[11px] text-gray-500 pt-4 border-t border-white/5">
